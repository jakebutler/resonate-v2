...
- M	app/__tests__/page.test.tsx
- R081	app/api/v2/__tests__/e2e-mvp-flow.test.ts	app/api/__tests__/e2e-mvp-flow.test.ts
- A	app/api/blog-pr-status/route.ts
- R095	app/api/v2/claim-map/__tests__/route.test.ts	app/api/claim-map/__tests__/route.test.ts
- R094	app/api/v2/claim-map/route.ts	app/api/claim-map/route.ts
- R097	app/api/v2/editorial-outline/__tests__/route.test.ts	app/api/editorial-outline/__tests__/route.test.ts
- R093	app/api/v2/editorial-outline/route.ts	app/api/editorial-outline/route.ts
- R096	app/api/v2/generate-draft/__tests__/route.test.ts	app/api/generate-draft/__tests__/route.test.ts
- R096	app/api/v2/generate-draft/route.ts	app/api/generate-draft/route.ts
- R095	app/api/v2/long-form-draft/__tests__/route.test.ts	app/api/long-form-draft/__tests__/route.test.ts
- R097	app/api/v2/long-form-draft/route.ts	app/api/long-form-draft/route.ts
- R093	app/api/v2/ops/validate-workflow/__tests__/route.test.ts	app/api/ops/validate-workflow/__tests__/route.test.ts
- R095	app/api/v2/ops/validate-workflow/route.ts	app/api/ops/validate-workflow/route.ts
- A	app/api/providers/validate/route.ts
- R097	app/api/v2/research-brief/__tests__/route.test.ts	app/api/research-brief/__tests__/route.test.ts
- R094	app/api/v2/research-brief/route.ts	app/api/research-brief/route.ts
- R100	app/api/v2/validate-youtube/route.ts	app/api/validate-youtube/route.ts
- A	app/calendar/page.tsx
- M	app/ideas/page.tsx
- M	app/page.tsx
- A	app/research/page.tsx
- A	app/research/review/[postId]/page.tsx
- D	app/v2/page.tsx
- D	app/v2/research/page.tsx
- M	components/EditorPageRouter.tsx
- M	components/IdeaDetail/IdeaDetail.tsx
- M	components/IdeasPage/IdeasPage.tsx
- M	components/IdeasPage/__tests__/IdeasPage.test.tsx
- M	components/PersistedPublishingPanel.tsx
- A	components/PublishingPanelErrorBoundary.tsx
- A	components/ResearchApp.tsx
- A	components/SocialConnectionsPanel.tsx
- D	components/V2ResonateApp.tsx
- M	components/__tests__/IdeasPage.test.tsx
- M	components/__tests__/PersistedPublishingPanel.test.tsx
- R062	components/__tests__/V2ResonateApp.test.tsx	components/__tests__/ResearchApp.test.tsx
- A	components/shell/BrandSelector.tsx
- A	components/shell/FilterGroup.tsx
- A	components/shell/HighlightCard.tsx
- A	components/shell/MainCard.tsx
- A	components/shell/Notice.tsx
- A	components/shell/PageHeader.tsx
- A	components/shell/PanelHeading.tsx
- A	components/shell/SegmentedControl.tsx
- A	components/shell/Shell.tsx
- A	components/shell/SidebarCard.tsx
- A	components/shell/VariantReviewPanel.tsx
- A	components/shell/WorkspaceLayout.tsx
- A	components/shell/tokens.ts
- M	components/ui/button.tsx
- M	convex/__tests__/ideasApi.test.ts
- R052	convex/__tests__/v2Publishing.test.ts	convex/__tests__/publishing.test.ts
- R096	convex/__tests__/spawnV2Posts.test.ts	convex/__tests__/spawnPosts.test.ts
- M	convex/_generated/api.d.ts
- M	convex/_generated/api.js
- M	convex/_generated/dataModel.d.ts
- M	convex/_generated/server.d.ts
...
- M	convex/ideas.ts
- R071	convex/v2Publishing.ts	convex/publishing.ts
- R100	convex/v2Research.ts	convex/research.ts
- M	convex/schema.ts
- A	convex/v2Migration.ts
- A	docs/adr/0005-convex-system-of-record.md
- M	docs/changelog.md
- M	docs/cutover-checklist.md
- A	docs/eval/reviewable-parity-script.md
- M	docs/glossary.md
- M	docs/project-status.md
- M	docs/smoke-runs/2026-06-06-authenticated-smoke.md
- M	docs/smoke-runs/2026-06-06-production-readiness.md
- A	docs/v1-ideas-import.md
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/README.md
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/_tables/documents.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/capturedIdeaEntries/documents.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/capturedIdeaEntries/generated_schema.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/capturedIdeaPostLinks/documents.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/capturedIdeaPostLinks/generated_schema.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/capturedIdeaV2PostLinks/documents.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/capturedIdeaV2PostLinks/generated_schema.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/capturedIdeas/documents.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/capturedIdeas/generated_schema.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/ideas/documents.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/ideas/generated_schema.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/posts/documents.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/posts/generated_schema.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/settings/documents.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/settings/generated_schema.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2AuditEvents/documents.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2AuditEvents/generated_schema.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2BrandMemberships/documents.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2BrandMemberships/generated_schema.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2Brands/documents.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2Brands/generated_schema.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2Channels/documents.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2Channels/generated_schema.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2ClaimMaps/documents.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2ClaimMaps/generated_schema.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2Claims/documents.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2Claims/generated_schema.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2EditorialOutlines/documents.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2EditorialOutlines/generated_schema.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2LongFormDrafts/documents.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2LongFormDrafts/generated_schema.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2Posts/documents.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2Posts/generated_schema.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2ProviderStates/documents.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2ProviderStates/generated_schema.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2PublishAttempts/documents.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2PublishAttempts/generated_schema.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2PublishingIntents/documents.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2PublishingIntents/generated_schema.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2ResearchBriefs/documents.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2ResearchBriefs/generated_schema.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2ResearchSources/documents.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/v2ResearchSources/generated_schema.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/workflowDrafts/documents.jsonl
- A	docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/workflowDrafts/generated_schema.jsonl
- A	lib/__tests__/calendarDates.test.ts
- R093	lib/__tests__/v2ClaimMap.test.ts	lib/__tests__/claimMap.test.ts
- R086	lib/__tests__/v2.test.ts	lib/__tests__/domain.test.ts
- M	lib/__tests__/helpers/providerAdapterContract.ts
- R093	lib/__tests__/v2Outline.test.ts	lib/__tests__/outline.test.ts
- R099	lib/__tests__/v2ProviderAdapters.test.ts	lib/__tests__/providerAdapters.test.ts
- R093	lib/__tests__/v2Research.test.ts	lib/__tests__/research.test.ts
- A	lib/calendarDates.ts
- R080	lib/v2.ts	lib/domain.ts
- M	lib/github.ts
- A	lib/ideasAdapter.ts
- R093	lib/v2ProviderAdapters.ts	lib/providerAdapters.ts
- M	lib/v2Migration.ts
- M	next.config.ts
- M	proxy.ts
- M	scripts/buffer-live-validation.mjs
- M	scripts/cutover-smoke.mjs
- A	scripts/rename-drop-v2.mjs
- A	scripts/v2-import-ideas.mjs
- M	scripts/zernio-live-validation.mjs

### Working Tree Snapshot

- M  app/__tests__/page.test.tsx
- R  app/api/v2/__tests__/e2e-mvp-flow.test.ts -> app/api/__tests__/e2e-mvp-flow.test.ts
- A  app/api/blog-pr-status/route.ts
- R  app/api/v2/claim-map/__tests__/route.test.ts -> app/api/claim-map/__tests__/route.test.ts
- R  app/api/v2/claim-map/route.ts -> app/api/claim-map/route.ts
- R  app/api/v2/editorial-outline/__tests__/route.test.ts -> app/api/editorial-outline/__tests__/route.test.ts
- R  app/api/v2/editorial-outline/route.ts -> app/api/editorial-outline/route.ts
- R  app/api/v2/generate-draft/__tests__/route.test.ts -> app/api/generate-draft/__tests__/route.test.ts
- R  app/api/v2/generate-draft/route.ts -> app/api/generate-draft/route.ts
- R  app/api/v2/long-form-draft/__tests__/route.test.ts -> app/api/long-form-draft/__tests__/route.test.ts
- R  app/api/v2/long-form-draft/route.ts -> app/api/long-form-draft/route.ts
- R  app/api/v2/ops/validate-workflow/__tests__/route.test.ts -> app/api/ops/validate-workflow/__tests__/route.test.ts
- R  app/api/v2/ops/validate-workflow/route.ts -> app/api/ops/validate-workflow/route.ts
- A  app/api/providers/validate/route.ts
- R  app/api/v2/research-brief/__tests__/route.test.ts -> app/api/research-brief/__tests__/route.test.ts
- R  app/api/v2/research-brief/route.ts -> app/api/research-brief/route.ts
- R  app/api/v2/validate-youtube/route.ts -> app/api/validate-youtube/route.ts
- A  app/calendar/page.tsx
- M  app/ideas/page.tsx
- M  app/page.tsx
- A  app/research/page.tsx
...
- M  components/__tests__/IdeasPage.test.tsx
- M  components/__tests__/PersistedPublishingPanel.test.tsx
- R  components/__tests__/V2ResonateApp.test.tsx -> components/__tests__/ResearchApp.test.tsx
- A  components/shell/BrandSelector.tsx
- A  components/shell/FilterGroup.tsx
- A  components/shell/HighlightCard.tsx
- A  components/shell/MainCard.tsx
...
- M  components/ui/button.tsx
- M  convex/__tests__/ideasApi.test.ts
- R  convex/__tests__/v2Publishing.test.ts -> convex/__tests__/publishing.test.ts
- R  convex/__tests__/spawnV2Posts.test.ts -> convex/__tests__/spawnPosts.test.ts
- M  convex/_generated/api.d.ts
- M  convex/_generated/api.js
- M  convex/_generated/dataModel.d.ts
- M  convex/_generated/server.d.ts
...
- M  convex/githubPrSync.ts
- M  convex/ideas.ts
- R  convex/v2Publishing.ts -> convex/publishing.ts
- R  convex/v2Research.ts -> convex/research.ts
- M  convex/schema.ts
- A  convex/v2Migration.ts
- A  docs/adr/0005-convex-system-of-record.md
- M  docs/changelog.md
...
- A  docs/v1-legacy-data/snapshot_healthy-platypus-553_1780767659398368636/workflowDrafts/generated_schema.jsonl
- A  lib/__tests__/calendarDates.test.ts
- R  lib/__tests__/v2ClaimMap.test.ts -> lib/__tests__/claimMap.test.ts
- R  lib/__tests__/v2.test.ts -> lib/__tests__/domain.test.ts
- M  lib/__tests__/helpers/providerAdapterContract.ts
- R  lib/__tests__/v2Outline.test.ts -> lib/__tests__/outline.test.ts
- R  lib/__tests__/v2ProviderAdapters.test.ts -> lib/__tests__/providerAdapters.test.ts
- R  lib/__tests__/v2Research.test.ts -> lib/__tests__/research.test.ts
- A  lib/calendarDates.ts
- R  lib/v2.ts -> lib/domain.ts
- M  lib/github.ts
- A  lib/ideasAdapter.ts
- R  lib/v2ProviderAdapters.ts -> lib/providerAdapters.ts
- M  lib/v2Migration.ts
- M  next.config.ts
- M  proxy.ts
- M  scripts/buffer-live-validation.mjs
