...
import { POST } from "@/app/api/v2/claim-map/route";
import { makeSourceRecord } from "@/lib/v2";

function makeRequest(body: object): NextRequest {
  return new Request("http://localhost/api/v2/claim-map", {
    method: "POST",
...
describe("POST /api/v2/claim-map", () => {
