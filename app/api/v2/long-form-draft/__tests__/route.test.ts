...
import { POST } from "@/app/api/v2/long-form-draft/route";
import { makeClaim, makeEditorialOutline, makeOutlineSection, makeTakeawayRow } from "@/lib/v2";

function makeRequest(body: object): NextRequest {
  return new Request("http://localhost/api/v2/long-form-draft", {
    method: "POST",
...
describe("POST /api/v2/long-form-draft", () => {
