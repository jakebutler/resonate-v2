...
import { POST } from "@/app/api/v2/ops/validate-workflow/route";
import { createBlogPostPR } from "@/lib/github";

function makeRequest(headers?: Record<string, string>): NextRequest {
  return new Request("http://localhost/api/v2/ops/validate-workflow", {
    method: "POST",
    headers,
  }) as unknown as NextRequest;
}

describe("POST /api/v2/ops/validate-workflow", () => {
